...
#
#func stamp_equipped():
	#SignalManager.stamp_equippedfunc(slots,currently_selected,inventory)
#
#func stamp_unequipped():
	#SignalManager.stamp_unequippedfunc(slots,currently_selected,inventory)
#
#func _ready():
...
#func _unhandled_input(event):
	##var slot = slots[currently_selected]
			...
			#SignalManager.equipstamp(slots, sealslots, currently_selected, inventoryc)
			#
		#
