...
#@onready var savelocationlabel: Label = $saveshow/Sprite2D/savelocationlabel
#@onready var lifelabel: Label = $saveshow/HBoxContainer/Lifemax/Lifelabel
#@onready var deathslabel: Label = $saveshow/HBoxContainer/Lifemax2/Deathslabel
